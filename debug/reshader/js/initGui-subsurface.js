...
function initGUI() {
    ...
    var Config = function() {
        ...
        this.thickness = MatUNIFORMS['thickness'];
        this.subsurfacePower = MatUNIFORMS['subsurfacePower'];
    };
    ...
    //clearCoat
    var subsurfaceFolderController = gui.addFolder('subsurfaceFolder');
    var thicknessController = subsurfaceFolderController.add(options, 'thickness', 0, 1, 0.1);
    thicknessController.onChange(function(value){
        changeMaterialUniforms('thickness', value);
    });
    var subsurfacePowerController = subsurfaceFolderController.add(options, 'subsurfacePower', 0, 40, 1);
    subsurfacePowerController.onChange(function(value){
        changeMaterialUniforms('subsurfacePower', value);
    });
