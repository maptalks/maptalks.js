...
Map.include(/** @lends Map.prototype */{
     ...
     */
    _pointsAtResToContainerPoints: function (points, targetRes, altitudes = []) {
     ...
     * @function
     */
    _containerPointToPoint(p, zoom, out) {
    ...
    _containerPointToPointAtRes: function () {
        ...
        return function (p, res, out) {
            if (this.isTransforming()) {
                ...
                return (this.getResolution() === res) ? out : this._pointToPointAtRes(out, res, out);
            }
