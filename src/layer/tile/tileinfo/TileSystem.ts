 ...
 * @static
 */
TileSystem['web-mercator'] = new TileSystem([1, -1, -semiCircum, semiCircum]);
 ...
 * @static
 */
TileSystem['tms-global-mercator'] = new TileSystem([1, 1, -semiCircum, -semiCircum]);
 ...
 * @static
 */
TileSystem['tms-global-geodetic'] = new TileSystem([1, 1, -180, -90]);
 ...
 * @static
 */
TileSystem['baidu'] = new TileSystem([1, 1, 0, 0]);
