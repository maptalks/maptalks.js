...
class OverlayLayer extends Layer {
    ...
    constructor(id, geometries?: Geometry | Array<Geometry>, options?: OverlayLayerOptionsType) {
        //@ts-ignore
     ...
     * @return {Geometry[]}
     */
    getGeometries(filter?, context?): Array<Geometry> {
        if (!filter) {
     ...
     */
    filter(fn, context): Array<Geometry> {
        const selected = [];
     ...
     * @return {OverlayLayer} this
     */
    addGeometry(geometries: Geometry | Array<Geometry>, fitView?) {
        if (!geometries) {
            return this;
        }
        //@ts-ignore
     ...
     */
    removeGeometry(geometries: Geometry | Array<Geometry>) {
