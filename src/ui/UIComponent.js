...
class UIComponent extends Eventable(Class) {
    ...
    _getViewPoint() {
        ...
        if (this._owner) {
            let altitude = 0;
            if (this._owner._getAltitudeContainsLayerAltitude) {
                altitude = this._owner._getAltitudeContainsLayerAltitude();
            } else if (this._owner.getAltitude) {
                altitude = this._owner.getAltitude();
            }
            if (altitude > 0) {
