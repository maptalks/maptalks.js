...
export function removeFromArray(obj, array: Array<any>) {
...
export function forEachCoord(arr, fn, context?: any) {
 ...
 * @memberOf Util
 */
export function isArrayHasData(obj: Array<any>) {
...
function approx(val, expected, delta?: number) {
