 ...
 * @memberOf StringUtil
 */
export function stringWidth(text: string, font?: any) {
    //@ts-ignore
    if (stringWidth.node) {
        //@ts-ignore
 ...
 * @memberOf StringUtil
 */
export function splitContent(content: string, font, wrapWidth, textWidth) {
 ...
 * @memberOf StringUtil
 */
export function replaceVariable(str: string, props) {
    if (!isString(str)) {
        return str;
    }
 ...
 * @memberOf StringUtil
 */
export function splitTextToRow(text: string, style) {
