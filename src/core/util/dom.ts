 ...
 * @memberOf DomUtil
 */
export function addDomEvent(obj: HTMLElement | Document, typeArr: string, handler: Function, context?) {
...
export function preventSelection(dom: HTMLElement) {
 ...
 * @memberOf DomUtil
 */
export function computeDomPosition(dom: HTMLElement) {
 ...
 * @memberOf DomUtil
 */
export function getEventContainerPoint(ev, dom: HTMLElement) {
    if (!ev) {
        ev = window.event;
    }
    //@ts-ignore
 ...
 * @memberOf DomUtil
 */
export function getClass(el: HTMLElement) {
    //@ts-ignore
    return isNil(el.className.baseVal) ? el.className : el.className.baseVal;
}


export function setOpacity(el: HTMLElement, value: string | number) {
...
export function setTransformMatrix(el: HTMLElement, m) {
...
export function removeTransform(el: HTMLElement) {
...
export function measureDom(parentTag, dom: HTMLElement) {
