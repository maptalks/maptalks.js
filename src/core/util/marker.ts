...
const SIZE = [];
export function getVectorMarkerFixedExtent(out, symbol, size?: Array<number>) {
...
export function getDefaultHAlign(markerType: string) {
...
export function getDefaultVAlign(markerType: string) {
...
export function getVectorMarkerAnchor(symbol, w: number, h: number) {
    const padding = getVectorPadding(null);
...
export function getImageMarkerFixedExtent(out, symbol, resources?: any) {
