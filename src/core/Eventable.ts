...
function Eventable<TBase extends Constructor>(Base: TBase) {
    return class extends Base {
         ...
         */
        on(eventsOn: string, handler: Function, context?) {
            if (!eventsOn) {
                return this;
            }
         ...
         */
        off(eventsOff: string, handler: Function, context) {
         ...
         */
        listens(eventType: string, handler?: Function, context?) {
