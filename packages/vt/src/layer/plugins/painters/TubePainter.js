...
class TubePainter extends BasicPainter {
    ...
    createMesh(geo, transform) {
        ...
        setUniformFromSymbol(
            ...
            2,
            (v) => {
                const scale = StyleUtil.getTubeSizeScale(
                    this.dataConfig.metric,
                );
                return scale * v;
            },
        );
        ...
        // 10000 是100米转厘米
        const centiMeterToLocal = map
            .distanceToPointAtRes(100, 100, geometry.properties.tileResolution)
            ["_multi"](tileRatio / 10000)
            .toArray();
    ...
    getUniformValues(map, context) {
        ...
        uniforms.currentTime =
            this.layer.getRenderer().getFrameTimestamp() || 0;
