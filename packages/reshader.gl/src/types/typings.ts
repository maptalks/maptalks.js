...
export type ShaderUniformValue = number | boolean | string | NumberArray | null | ShaderUniformTexture

export type ShaderUniformTexture = AbstractTexture | Texture | GraphicsTexture
