...
import { mat4, vec3, createREGL } from '@maptalks/regl';


class TileLayerTerrainRenderer extends maptalks.renderer.TileLayerGLRenderer {
    constructor(layer, terrainHelper) {
        super(layer);
        this._terrainHelper = terrainHelper;
        const neighborCount = terrainHelper.getNeighborCount();
    }
