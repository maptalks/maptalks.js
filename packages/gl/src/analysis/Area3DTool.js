...
export default class Area3DTool extends Measure3DTool {
    ...
    _addHelperLayer() {
        ...
        this._helperLayer = new maptalks.DrawToolLayer(maptalks.INTERNAL_LAYER_PREFIX + '_area3dtool').addTo(this._map);
        this._markerLayer = new maptalks.DrawToolLayer(maptalks.INTERNAL_LAYER_PREFIX + '_area3dtool_marker').addTo(this._map);
    }
