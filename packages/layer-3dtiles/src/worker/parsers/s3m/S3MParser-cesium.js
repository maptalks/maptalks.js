//https://github.com/fuzhenn/cesium/commits/main
...
DXTTextureDecode.getType = function(width, height, block, format){
    if (block == null || height == 0 || width == 0) {
        return null;
    }
    var flags = 0;
...
S3MModelParser.prototype.parseCompressVertex = function(buffer, view, bytesOffset, vertexPackage) {
    ...
    attributes.push({
        ...
        typedArray: vertexBuffer,
        componentsPerAttribute: vertexDimension,
        componentDatatype: S3MModelParser.ComponentDatatype.SHORT,
        offsetInBytes: 0,
        strideInBytes: vertexStride,
        normalize: false
    });
...
S3MModelParser.prototype.parseBuffer = function(unzipBuffer, bytesOffset) {
    ...
    const view = new DataView(unzipBuffer);
    bytesOffset = 0;
...
export default function parse(data) {
    ...
    return rawGLTFPromise.then(function(rawGLTF) {
