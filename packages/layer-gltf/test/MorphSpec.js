    ...
    it('add gltf marker with morph', (done) => {
        ...
        marker.on('load', () => {
            setTimeout(function() {
                ...
                expect(testMatrix0).to.be.eql([1.0466131638156042, 0, 0, 0, 0, 1.046613163724577, -8.366018023231138e-17, 0, 0, 6.40865730450394e-17, 1.366274427705341, 0, 0, 0, 0, 1]);
                const testMatrix1 = marker.getMeshes(null, null, 250)[0].localTransform;
                expect(testMatrix1).to.be.eql([1.0466131638156042, 0, 0, 0, 0, 1.046613163724577, -8.366018023231138e-17, 0, 0, 6.40865730450394e-17, 1.366274427705341, 0, 0, 0, 0, 1]);
                const testMatrix2 = marker.getMeshes(null, null, 500)[0].localTransform;
                expect(testMatrix2).to.be.eql([1.0466131638156042, 0, 0, 0, 0, 1.046613163724577, -8.366018023231138e-17, 0, 0, 6.40865730450394e-17, 1.366274427705341, 0, 0, 0, 0, 1]);
                const testMatrix3 = marker.getMeshes(null, null, 750)[0].localTransform;
                expect(testMatrix3).to.be.eql([1.0466131638156042, 0, 0, 0, 0, 1.046613163724577, -8.366018023231138e-17, 0, 0, 6.40865730450394e-17, 1.366274427705341, 0, 0, 0, 0, 1]);
                done();
            }, 100);
        })
    });
