...
describe('Map.Camera', function () {
    ...
    it('should generate dom css matrix', function () {
        map.setPitch(75);
        map.setBearing(45);
        expect(maptalks.Util.join(map.domCssMatrix)).to.be.eql([31.819805153394643,-8.235571585149868,0.7344093073253941,0.6830127018922193,31.819805153394636,8.23557158514987,-0.7344093073253942,-0.6830127018922194,0,-43.466662183008076,-0.2782951402071539,-0.25881904510252074,0,0,48.17871840092618,45].join());
    });
});
