...
describe('#Ellipse', function () {
    ...
    it('getShell', function () {
        var ellipse = new Ellipse([0, 0], 1000, 800);
    ...
    describe('geometry fires events', function () {
        it('canvas events', function () {
            var vector = new Ellipse(center, 1, 1);
    ...
    describe('can be treated as a polygon', function () {
        it('has shell', function () {
            var vector = new Ellipse(center, 100, 50);
    ...
    it('Ellipse._containsPoint', function () {
        ...
        var geometry = new Ellipse(center, 20, 10, {
            symbol: {
                'lineWidth': 6
            }
        });
