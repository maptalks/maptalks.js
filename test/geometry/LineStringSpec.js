...
describe('#LineString', function () {
    ...
    it('getCoordinates', function () {
        ...
        var polyline = new LineString(path);
        layer.addGeometry(polyline);
    ...
    describe('getCenter', function () {
        it('should返回笛卡尔坐标系上的点集合的中心点', function () {
            ...
            expect(polyline.getCenter()).to.closeTo(new Coordinate(0, 30));
        });
    });
    ...
    it('getExtent', function () {
        ...
        expect(polyline.getExtent()).to.eql(new Extent(0, 0, 0, 80));
    });
    ...
    describe('geometry fires events', function () {
        it('events', function () {
            ...
            var vector = new Polyline(points);
    ...
    it('containsPoint', function () {
        var lineWidth = 8;
        var line = new LineString([map.getCenter(), map.getCenter().add(0.1, 0)], {
            symbol: {
                'lineWidth': lineWidth
            }
        });
    ...
    it('containsPoint with arrow of point', function () {
        var lineWidth = 8;
        var line = new LineString([map.getCenter().substract(0.1, 0), map.getCenter(), map.getCenter().add(0.1, 0)], {
            arrowStyle: 'classic',
