import { replaceVariable } from 'core/util';
import { getSymbolStamp } from 'core/util/style';
...
describe('core/util', function () {
    ...
    describe('replace variable', function () {
        ...
        it('input null', function () {
            var str = '{foo} is not {foo2}.';
            var r = replaceVariable(str, null);
            expect(r).to.eql(str);
        });
    });
    ...
    it('getSymbolStamp', function () {
        ...
        expect(getSymbolStamp(symbol)).to.be.eql(expected);
